...
grad_non_regularized = (X' * difference_hyp_actual)/m; %the vectorized implementation of gradient equation

grad = grad_non_regularized .+ gradient_regularization_term;
